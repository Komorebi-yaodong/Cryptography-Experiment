...
if os.name == 'posix':
    from AITMCLAB.Crypto.Random.OSRNG.posix import new
elif os.name == 'nt':
    from AITMCLAB.Crypto.Random.OSRNG.nt import new
elif hasattr(os, 'urandom'):
    from AITMCLAB.Crypto.Random.OSRNG.fallback import new
else:
